...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class CursorManager : Singleton<CursorManager>
    {
        ...
        void LateUpdate()
        {
            if (TrainingGazeManager.Instance == null || CursorOnHolograms == null || CursorOffHolograms == null)
            {
                return;
            }

            if (TrainingGazeManager.Instance.Hit)
            {
            ...
            this.gameObject.transform.position = TrainingGazeManager.Instance.Position + TrainingGazeManager.Instance.Normal * DistanceFromCollision;

            // Orient the cursor to match the surface being gazed at.
            gameObject.transform.up = TrainingGazeManager.Instance.Normal;
        }
    }
}