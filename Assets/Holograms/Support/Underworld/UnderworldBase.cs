...
public class UnderworldBase : Singleton<UnderworldBase>
{
    ...
    void Start()
    {
        ...
        if (TrainingGazeManager.Instance)
        {
            ...
            TrainingGazeManager.Instance.RaycastLayerMask = TrainingGazeManager.Instance.RaycastLayerMask & ignoreNavLayerMask;
        }
    }
    ...
    void LateUpdate()
    {
        ...
        {
            HolographicSettings.SetFocusPointForFrame(TrainingGazeManager.Instance.HitInfo.point, -Camera.main.transform.forward);
        }
    }
